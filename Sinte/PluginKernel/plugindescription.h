...
#define AU_COCOA_VIEWFACTORY_NAME AUCocoaViewFactory_6EB07625C76546F0A5FCCBE67DDBEA4F
#define AU_COCOA_VIEW_NAME AUCocoaView_6EB07625C76546F0A5FCCBE67DDBEA4F
...
const char* kAAXBundleID = "rackafxuser.aax.Sinte.bundleID";
const char* kVST3BundleID = "rackafxuser.vst3.Sinte.bundleID";

// --- For AU: make sure BOTH the Plugin Target and the CocoaUI Target PRODUCT_BUNDLE_IDENTIFIER settings match these strings
const char* kAUBundleID = "rackafxuser.au.Sinte.bundleID";

// --- plugin NAME
/* AU only: this MUST EXACLTY match the Product Name in Build Settings for BOTH the CocoaUI and your Plugin Targets! */
const char* kPluginName = "Sinte";     // 31 chars max for AAX
const char* kShortPluginName = "Sinte";    // 15 chars max for AAX
...
const char* kVSTFUID = "{6EB07625-C765-46F0-A5FC-CBE67DDBEA4F}"; /// NOTE: you need the enclosing { }
